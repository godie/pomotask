        ...
        <form.Field
          ...
          children={(field) => (
            <div className="space-y-3">
              <label className="font-label text-xs uppercase tracking-wider text-on_surface_variant">
                Brand Color
              </label>
              <div className="flex gap-4 flex-wrap">
                {['#ff2d78', '#00ffcc', '#ffe04a', '#8c0038', '#004d4d', '#665200'].map((c) => (
                  <button
                    key={c}
                    type="button"
                    ...
                    className={cn(
                      ...
                      field.state.value === c ? "border-on_surface scale-110" : "border-transparent"
                    )}
